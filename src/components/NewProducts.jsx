...
const NewProducts = () => {
  ...
  return (
    ...
    <Container className="my-5">
      <h2 className=" mb-4" >New Furniture!</h2>
              ...
              {productGroup.map((product) => {
                ...
                return (
                  ...
                  <span style={{ fontSize: '15px', color: '#333', marginLeft: '10px' }}>4.9</span>
                        ...
                        <Card.Text style={{textAlign: 'Right', fontSize: '20px', color: '#dc0202'}}>{product.Prod_Price.toLocaleString('en-US', { style: 'currency', currency: 'THB' })}฿
                           </Card.Text>
                      </Card.Body>
                    </Card>
                    </Link>
